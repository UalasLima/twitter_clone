<?php
    ...
    //O comando like é parecido com o igual, porém ele retorna caso a cadeia de caractere buscada esteja contida em uma do BD,não necessariamente que seja iguais, ex. Ota -> Otavio
    //O % a seguir indica que tudo bem haver caracteres adicionais á direita ou esquerda (dependendo de onde está o %) da string que se busca
        ...
        while($registro = mysqli_fetch_array($resultado_id, MYSQLI_ASSOC)) {
            echo '<a href"#" class="list-group-item">';
                ...
                echo '<p class="list-group-item-text pull-right">';
                    ...
                    //Pode-se no html6 criar seus próprios atributos utilizando a palavra data
