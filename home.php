	...
	<head>
		...
		<script type="text/javascript">
			$(document).ready(function() {
				...
				$('#btn_twett').click(function() {

					if($('#texto_twett').val().length > 0) {
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<form id="form_tweet" class="input-group">
							<input type="text" id="texto_twett" class="form-control" name="texto_tweet" placeholder="O que está acontecendo agora?" maxlength="140">
							<span class="input-group-btn">
								<button class="btn btn-default" id="btn_twett" type="button">Tweet</button>
							</span>
						</form>
					</div>
				</div>
